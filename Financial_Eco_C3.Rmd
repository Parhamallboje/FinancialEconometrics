---
title: "Financial Econometrics |CW3 -  Individual coursework"
author:
- Parham Allboje (01978793)
...
```{r}
sp500 <- read_excel("SP500WeekDays.xlsx")
...
### i.
```{r}
usMacro <- read_excel("USMacro_Quarterly.xls")
